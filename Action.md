...
cli push action eosadditapps addit '["violetstairs", 0, "https://addit.io/", "addit 조하요"]' -p violetstairs@active
cli push action eosadditapps addit '["violetstairn", 0, "https://addit.io/", "it just addit"]' -p violetstairn@active
...
# 평판 사이트 코멘트(평판) 조회
cli get table eosadditapps 0 comments
cli get table eosadditapps 0 comments
```
...
cli push action eosadditapps vote '["violetstairs", 0, 0, 1]' -p violetstairs@active
cli push action eosadditapps vote '["violetstairn", 0, 0, 1]' -p violetstairn@active
...
@ quantity : 
@ memo : 
cli push action eosadditapps transfer '["eosadditapps", "violetstairs", "1.0000 ADDIT", "I LOVE VS"]' -p eosadditapps@active
cli push action eosadditapps transfer '["eosadditapps", "violetstairn", "1.0000 ADDIT", "I LOVE VS"]' -p eosadditapps@active
cli push action eosadditapps transfer '["violetstairs", "violetstairn", "1.0000 ADDIT", "I LOVE VS"]' -p violetstairs@active
